            ...
            script {
                openshift.withCluster {
                    openshift.withProject('user25') {
                        ...
                        openshift.tag("coolstore/gateway:latest", "user25/gateway-canary:latest")
                    }
                }
            }
        }
        ...
        script {
            openshift.withCluster() {
                openshift.withProject('user25') {
                    ...
                    openshift.tag("user25/gateway-canary:latest", "user25/gateway:latest")
